...
declare namespace paper {
    ...
    class HitResult  {
         ...
         */
        type: 'segment' | 'handle-in' | 'handle-out' | 'curve' | 'stroke' | 'fill' |    'bounds' | 'center' | 'pixel'
         ...
         */
        name: 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' |    'left-center' | 'top-center' | 'right-center' | 'bottom- center'
    ...
    class Style  {
         ...
         * The color of the stroke.
         */
        strokeColor: Color | string | number | null
         ...
         * The fill color.
         */
        fillColor: Color | string | number | null
         ...
         * The shadow color.
         */
        shadowColor: Color | string | number | null
         ...
         * not specify its own color, the color defined by its layer is used instead.
         */
        selectedColor: Color | string | number | null
    ...
    class ToolEvent extends Event {
         ...
         * Creates a new Segment object.
         */
        constructor(tool?: Tool, type?: string, event?: object)
    ...
    class View  {
        ...
        /** 
         * @param type - the horizontal and vertical skew angles in degrees
         */
        handleMouseEvent(type: string, event: object, point?: Point): void
